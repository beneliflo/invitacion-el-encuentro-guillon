          ...
          <div className="overflow-hidden bg-white rounded-lg">
            <div className="relative flex flex-col">
              ...
              <div className="px-9 sm:px-20 bg-[url('/bg-bottom.png')] bg-contain bg-no-repeat bg-bottom pb-28 sm:pb-[280px] pt-11 sm:pt-[100px]">
                ...
                <h2 className="flex justify-between items-end border-b sm:border-b-2 border-black mt-4 sm:mt-10"><span className={cn(corporateACondPro.className, 'font-medium text-4xl sm:text-7xl')}>Sábado 19 de Agosto</span><span className={cn(sherika.className, 'uppercase font-normal text-2xl sm:text-5xl md:text-[52px] leading-none sm:leading-[58px] tracking-wider')}>19hs.</span></h2>
                <h2 className="flex justify-between items-end border-b sm:border-b-2 border-black mt-6 sm:mt-10"><span className={cn(corporateACondPro.className, 'font-medium text-4xl sm:text-7xl')}>Domingo 20 de Agosto</span><span className={cn(sherika.className, 'uppercase font-normal text-2xl sm:text-5xl md:text-[52px] leading-none sm:leading-[58px] tracking-wider')}>18hs.</span></h2>
